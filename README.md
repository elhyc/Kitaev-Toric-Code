...
Once we have our logical $0$ state, we can produce logical states $|01 \rangle_L$ and $ |10 \rangle_L$ by defining logical operators $(X_0)_L$ and  $(X_1)_L$ , which give us "logical bit flip" operators. These will map $|00\rangle_{L} \mapto |01 \rangle_L$ and $|00\rangle_{L} \mapto |10 \rangle_L$ respectively.
